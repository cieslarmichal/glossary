...
const DefinitionsWithExamples definitionsWithExamples{{"the alcoholic fermented juice of fresh grapes used as a beverage", boost::none},
                                                      {"wine or a substitute used in Christian communion services",        boost::none},
                                                      {"the alcoholic usually fermented juice of a plant product (such as a fruit) used as a beverage",
                                                                                                                           std::string{
                                                                                                                                   "blackberry wine"}},
                                                      {"something that invigorates or intoxicates",                        boost::none}};
const Sentences sentences{{"In addition to beer, a selection of local and national wines will be offered.."},
                          {"Who doesn't love delicious food paired with your favorite wine?"}};
const WordDescription expectedWordDescription{definitionsWithExamples, sentences};

const auto exampleContentPartlyWithoutMarks{": the alcoholic fermented juice of fresh grapes used as a beverage\n"
                                            "wine or a substitute used in Christian communion services\n"
                                            "//blackberry wine\n"
                                            "strawberry wine\n"
                                            "In addition to beer, a selection of local and national wines will be offered..\n"
...
const DefinitionsWithExamples someDefinitionsAndExamples{{"the alcoholic fermented juice of fresh grapes used as a beverage", boost::none}};
const Sentences someSentences{{"Who doesn't love delicious food paired with your favorite wine?"}};
const WordDescription wordDescriptionPartlyComplete{someDefinitionsAndExamples, someSentences};
...
TEST_F(WordDescriptionParserTest, givenEmptyContent_shoulNotReturnWordDescription)
{
...
{
    const auto content = stringHelper::getSplitLines(exampleContentPartlyWithoutMarks);

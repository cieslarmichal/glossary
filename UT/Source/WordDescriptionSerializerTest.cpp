...
const WordDescription wordDescriptionWithoutDefinitionsAndExamples{emptyDefinitionsWithExamples, sentences};
const WordDescription wordDescriptionWithoutSentences{definitionsWithExamples, emptySentences};
const WordDescription emptyWordDescription{emptyDefinitionsWithExamples, emptySentences};
}
...
TEST_F(WordDescriptionSerializerTest, givenEmptyWordDescription_shouldReturnEmptyJson)
{
    const auto serializedWordDescription = serializer.serialize(emptyWordDescription);
...
{
    const auto serializedWordDescription = serializer.serialize(wordDescriptionWithoutDefinitionsAndExamples);

    EXPECT_EQ(serializedWordDescription.dump(), expectedSerializedWordDescriptionWithoutDefinitionsAndExamples);
}

TEST_F(WordDescriptionSerializerTest,
       givenWordDescriptionWithoutSentencesField_shouldReturnSerializedWordDescriptionWithoutSentences)
{
    const auto serializedWordDescription = serializer.serialize(wordDescriptionWithoutSentences);

    EXPECT_EQ(serializedWordDescription.dump(), expectedSerializedWordDescriptionWithoutSentences);
}

TEST_F(WordDescriptionSerializerTest, givenEmptyJson_shouldReturnEmptyWordDescription)
{
    const auto serializedWordDescription = serializer.serialize(emptyWordDescription);
       ...
       givenSerializedWordDescriptionWithoutDefinitionsAndExamplesField_shouldReturnWordDescriptionWithoutDefinitionsAndExamples)
{
    ...
    EXPECT_EQ(actualWordDescription, wordDescriptionWithoutDefinitionsAndExamples);
...
{
    const auto actualWordDescription = serializer.deserialize(prepareWordDescriptionWithoutSentencesJson());

...
public:
    ...
    MOCK_CONST_METHOD1(addWordDescription, void(const wordsDescriptionsDb::WordDescription&));
    MOCK_CONST_METHOD1(getWordDescription,
                       boost::optional<wordsDescriptionsDb::WordDescription>(const EnglishWord&));

...
std::string StatisticsJsonSerializer::serialize(const std::vector<WordStatistics>& statistics) const
{
...
std::vector<WordStatistics> StatisticsJsonSerializer::deserialize(const std::string& jsonText) const
{
    try
    {
...
std::vector<WordStatistics> StatisticsJsonSerializer::readStatistics(const nlohmann::json& json) const
{

...
const std::vector<WordStatistics> statisticsWithOneWord{statisticsPerWord1};
const std::vector<WordStatistics> statistics{statisticsPerWord1, statisticsPerWord2};

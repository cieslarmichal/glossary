...
std::vector<Dictionary> DictionaryJsonSerializer::deserialize(const std::string& serializedDictionaries) const
{
    try
    {
...
nlohmann::json
DictionaryJsonSerializer::getJsonFromDictionaryWords(const std::vector<DictionaryWord>& words) const
{
...
std::vector<Dictionary> DictionaryJsonSerializer::getDictionariesFromJson(const nlohmann::json& json) const
{
    std::vector<Dictionary> dictionariesFromJson{};
...
{
    std::vector<DictionaryWord> dictionaryWordsFromJson{};
...
DictionaryJsonSerializer::getDictionaryWordFromJson(const nlohmann::json& dictionaryWordJson) const
{
    ...
    return DictionaryWord{dictionaryWordJson[englishWordField].get<std::string>(), std::nullopt};
}

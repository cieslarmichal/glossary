...
public:
    ...
    generateWordDescription(const wordsDescriptionsDb::EnglishWord&) const override;
    wordsDescriptionsDb::WordsDescriptions
    generateWordsDescriptions(const wordsDescriptionsDb::EnglishWords&) const override;

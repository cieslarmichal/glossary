...
const DefinitionsWithExamples definitionsWithExamples{
    ...
    {"interest, attract", Example{"… he doesn't fetch the girls like William …"}},
    {"to give (a blow) by striking : deal", Example{"fetch him a clip on the chin"}},
    ...
    {"the distance along open water or land over which the wind blows", boost::none},
    ...
    {"to bring as a price : sell for", Example{"The artwork will fetch a high price."}},
};
...
const Description exampleDescription{definitionsWithExamples, sentences};

...
TranslatorFactoryImpl::TranslatorFactoryImpl(std::shared_ptr<webConnection::HttpHandler> httpHandlerInit)
...
{
    return std::make_unique<TranslatorImpl>(httpHandler, std::make_unique<TranslationDeserializerImpl>(),

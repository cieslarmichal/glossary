...
bool wordsDb::statisticsDb::StatisticsMemoryStorage::empty() const
{
    return statistics.empty();
}

Statistics::const_iterator StatisticsMemoryStorage::begin() const
{
    return statistics.begin();
}

Statistics::const_iterator StatisticsMemoryStorage::end() const
{
